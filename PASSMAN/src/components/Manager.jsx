    ...
    <>
      ...
      <div className='text-white'>
        ...
        <div>
          ...
          {passwordarray.length > 0 && <table className="table-fixed w-[70%] text-white mx-auto mt-4 rounded-t-xl rounded-b-xl overflow-hidden border-separate border-spacing-0">
