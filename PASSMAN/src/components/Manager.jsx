  ...
  return (
    <>
      ...
      <div className='text-white'>
        ...
        <h1 className='text-5xl font-bold text-center mt-10 flex items-center justify-center'>
          <img src="/lock-logo.png" alt="lock" width={55} height={50} />
        ...
        <div className="container mx-auto mt-10 flex flex-col gap-5 p-5 text-black items-center">
          <input onChange={savechange} value={form.site} type="text " placeholder="Website" className='rounded-md p-2 w-[90%] md:w-[50%] bg-green-100 border-3 border-green-600' name='site' />

          <div className="userpass bg-green-300/50 p-2 rounded-md flex gap-8 w-[90%] md:w-[50%] items-center justify-between">
            <input onChange={savechange} value={form.username} type="text" placeholder="Username" className='rounded-md p-2 bg-green-100 w-[75%] md:w-[70%] border-2 border-green-800' name='username' />
            <div className='relative'>
              ...
              <span className='absolute right-1 md:right-1.5 top-2.5 md:top-1.5 cursor-pointer'>
                <img ref={ref} className='md:w-8 w-6' src="./icons/eyes.svg" alt="" onClick={showpassword} /></span>
            </div>
          </div>
                ...
                return <tr className='' key={index}>
                  ...
                  <td className='text-center py-2 px-2 border-r border-black'>
                    <div className='flex items-center justify-center gap-4'>
                      ...
                      <img className='cursor-pointer w-4 md:w-6' src="./icons/copy.svg" alt="" onClick={() => copytext(item.password)} />
                    </div>
                  </td>
