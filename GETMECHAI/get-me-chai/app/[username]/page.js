      ...
      <div className='flex m-20 gap-5 w-[75%]'>
        ...
        <div className="payment bg-slate-800 w-1/2 rounded-2xl p-8">
          ...
          <form className='flex flex-col gap-4'>
            <input type="text" placeholder='Enter Name' className='bg-slate-700 p-2 rounded-md' />
            <input type="text" placeholder='Enter Amount' className='bg-slate-700 p-2 rounded-md' />
